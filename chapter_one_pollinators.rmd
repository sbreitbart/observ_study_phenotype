...
(((urban_mean - rural_mean) / abs(urban_mean)) * 100) # 155% fewer pollinators in city vs rural terminus
(((rural_mean - urban_mean) / abs(rural_mean)) * 100) # 61% more pollinators in rural terminus vs city
...
(((urban_mean - rural_mean) / abs(urban_mean)) * 100) # 39% higher richness in city vs rural terminus
(((rural_mean - urban_mean) / abs(rural_mean)) * 100) # 63% lower richness in rural terminus vs city
```
...
library(ggpubr)
Q3_regressions.evenness.gradient <- ggarrange(even,
                            even.u,
                            ncol = 2, nrow = 1, align = "h",
                            labels = list("A", "B"),
                            font.label = (size =16),
                            common.legend = TRUE)
Q3_regressions.evenness.gradient


dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_Evenness_gradientfigs.pdf", width = 6, height = 2.5)
```
...
library(ggpubr)
Q3_regressions.evenness.transects <- ggarrange(
                            even_transect,
                            even_transect.u,
                            ncol = 2, nrow = 1, align = "h",
                            labels = list("A", "B"),
                            font.label = (size =16),
                            common.legend = TRUE)
Q3_regressions.evenness.transects


dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_Evenness_transects.pdf", width = 6, height = 3)
```
