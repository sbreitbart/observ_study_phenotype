...
(((urban_mean - rural_mean) / abs(urban_mean)) * 100) # 200% fewer pollinators in city vs rural terminus
(((rural_mean - urban_mean) / abs(rural_mean)) * 100) # 67% more pollinators in rural terminus vs city
...
######## Transects
```{r}
car::Anova(lm_abun1.urbsubs.u_nohoney) # nothing sig
...
######### Transects
```{r}
car::Anova(lm.diversity_nohoney.urbsubs.u) # transect sig
...
(((urban_mean - rural_mean) / abs(urban_mean)) * 100) # 40% higher richness in city vs rural terminus
(((rural_mean - urban_mean) / abs(rural_mean)) * 100) # 67% lower richness in rural terminus vs city
```
...
# corridor subtransect had 0.6 units lower richness than non-corridor, on avg!
```
...
####### Transects
```{r}
car::Anova(lm.rich.urbsubs.u) # transect marg sig
