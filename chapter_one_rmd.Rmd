...
# check residuals
plot(simulateResiduals(height_lmer_gradient_01)) # looks good
plot(simulateResiduals(height_lmer_gradient_02)) # looks good
...
# check residuals
plot(simulateResiduals(height_lmer_subtr_01)) # looks good
plot(simulateResiduals(height_lmer_subtr_08)) # looks good
