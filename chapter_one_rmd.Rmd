...
urb_scores_poll_long <-
  read.csv(here::here("./clean_data/urb_scores_poll_long.csv"),
           header=T,
           na.strings=c("","NA"))

urb_scores_poll_all_long <-
  read.csv(here::here("./clean_data/urb_scores_poll_all_long.csv"),
           header=T,
           na.strings=c("","NA"))
...
fertile_pops_all_notNApods <-
  read.csv(here::here("./clean_data/fertile_pops_all_notNApods.csv"),
           header=T,
           na.strings=c("","NA"))


fertile_pops_all_notNApeds <-
  read.csv(here::here("./clean_data/fertile_pops_all_notNApeds.csv"),
           header=T,
           na.strings=c("","NA"))
...
# full model
poll_glmer_subtr_01 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist * as.factor(Year) * Transect_ID,
                             long_Transect_Data_18_19 %>%
...
poll_glmer_subtr_02 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + as.factor(Year):Transect_ID + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>% 
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
poll_glmer_subtr_03 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + as.factor(Year):Transect_ID + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>%
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
poll_glmer_subtr_04 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist:Transect_ID + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>%
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
poll_glmer_subtr_05 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist:Transect_ID + Transect_ID:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>%
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
poll_glmer_subtr_06 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>%
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
poll_glmer_subtr_07 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + as.factor(Year):Transect_ID + City_dist + as.factor(Year) + Transect_ID,
                             long_Transect_Data_18_19 %>%
                               filter(Transect_ID != 'Rural'),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
```{r}
## No transect yet
u_poll_glmer_gradient_1 <- glmer(Pollinia_removed ~ (1|Patch_ID/Plant_Num/Inflor) + Urb_score * as.factor(Year),
                                 urb_scores_poll_long,
                                 family = "poisson",
             glmerControl(optimizer="bobyqa",
                          optCtrl = list(maxfun = 100000)))
...
u_poll_glmer_gradient_1.1 <- glmer(Pollinia_removed ~ (1|Patch_ID/Plant_Num/Inflor) + Urb_score + as.factor(Year),
                                   urb_scores_poll_long,
                                   family = "poisson",
                                   glmerControl(optimizer="bobyqa",
                                                optCtrl = list(maxfun = 100000)))
...
## add transect
# FULL MODEL
u_poll_glmer_subtr_1 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + Urb_score * as.factor(Year) *Transect_ID,
                              urb_scores_poll_all_long,
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
u_poll_glmer_subtr_1.1 <- glmer((Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + Urb_score:as.factor(Year) + Urb_score:Transect_ID + Transect_ID:as.factor(Year) + as.factor(Year) + Transect_ID + Urb_score,
                                urb_scores_poll_all_long,
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
urbpoll_lm <- lm(Average_Pollinia ~ City_dist * as.factor(Year) * Transect_ID, 
...
diag_urb_poll_1 <- lm(Average_Pollinia ~ Urb_score * as.factor(Year) * Transect_ID,
...
###### INFLORESCENCE MEANS ########
######### GRADIENT
z1 <- lmer(Poll_rm_per_inflor ~ (1|Patch_ID/Plant_Num) * City_dist * as.factor(Year),
           long_inflor_means,
           REML = F)
summary(z1)
car::Anova(z1)
# interxn not sig but main effects are
z1.1 <- car::Anova(lmer(Poll_rm_per_inflor ~ (1|Patch_ID/Plant_Num) + City_dist + as.factor(Year),
                        long_inflor_means,
                        REML = F))
...
###### INFLORESCENCE MEANS ########
######### urban transects
z2 <- lmer(Poll_rm_per_inflor ~ (1|Patch_ID/Plant_Num) + City_dist * as.factor(Year) * Transect_ID,
           (long_inflor_means %>%
              filter(Transect_ID != 'Rural')),
           REML = F)
summary(z2)
...
###### PLANT MEANS ########
######### GRADIENT
z3 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID) + City_dist * as.factor(Year),
           long_plant_means,
           REML = F)
summary(z3)
car::Anova(z3)
...
z3.1 <- car::Anova(lmer(Poll_rm_per_plant ~ (1|Patch_ID) + City_dist + as.factor(Year),
                        long_plant_means,
                        REML = F))
...
###### PLANT MEANS ########
######### urban transects
z4 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
           (long_plant_means %>%
              filter(Transect_ID != 'Rural')),
           REML = F)
summary(z4 )
...
z4.1 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID) + City_dist:as.factor(Year) + City_dist:Transect_ID + Transect_ID:as.factor(Year) + Transect_ID + City_dist + as.factor(Year),
...
z4.2 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID) + City_dist:as.factor(Year) + Transect_ID:as.factor(Year) + Transect_ID + City_dist + as.factor(Year), 
             (long_plant_means %>%
                filter(Transect_ID != 'Rural')),
             REML = F)
summary(z4.2)
...
z4.3 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID) + Transect_ID + City_dist + as.factor(Year),
             (long_plant_means %>%
                filter(Transect_ID != 'Rural')),
             REML = F)
summary(z4.3)
...
z4.4 <- lmer(Poll_rm_per_plant ~ (1|Patch_ID)+ as.factor(Year),
...
# try out new glmer
## GRADIENT
y1 <- glmer(as.numeric(Pods_per_plant) ~ (1|Patch_ID) + City_dist * as.factor(Year),
...
y1.1 <- glmer(as.numeric(Pods_per_plant) ~ (1|Patch_ID) + City_dist + as.factor(Year),
              long_plant_means_pods,
              family = "poisson")
summary(y1.1)
car::Anova(y1.1)
...
y1.2 <- glmer(as.numeric(Pods_per_plant) ~ (1|Patch_ID) + as.factor(Year),
              long_plant_means_pods,
              family = "poisson")
summary(y1.2)
...
## URBAN SUBTRANSECTS
y2 <- glmer(as.numeric(Pods_per_plant) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
...
allpod_lm <- lm(Viable_Pods ~ City_dist * Year ,
                data = fertile_pops_all_notNApods)
...
# try  transformations
gg_reshist(lm((Viable_Pods)^(1/2) ~ Urb_score * Year, data = fertile_pops_all_notNApods), bins=20)
plot(lm((Viable_Pods)^(1/2) ~ Urb_score * Year , data = fertile_pops_all_notNApods))
ggqqplot((fertile_pops_all_notNApods$Viable_Pods)^(1/2))
shapiro.test((fertile_pops_all_notNApods$Viable_Pods)^(1/2))
##### GOING WITH THIS ONE. LOOKS GOOD.
...
summary(urbpods_lm)
summary((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods)
sd((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods)

qplot((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods)

ggqqplot((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods)
...
gg_reshist(lm(log(Viable_Pods+1) ~ City_dist * Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))), bins=20)
par(mfrow=c(2,2))
plot(lm(log(Viable_Pods+1) ~ City_dist* Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))))
summary(lm(log(Viable_Pods+1) ~ City_dist* Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))))
ggqqplot(log((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods+1))
shapiro.test(log((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods+1))
# still not good (too strong?)


# try sq rt & cube root
gg_reshist(lm(Viable_Pods^(1/2) ~ City_dist * Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))), bins=20)
plot(lm(Viable_Pods^(1/2) ~ City_dist * Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))))
summary(lm(Viable_Pods^(1/2) ~ City_dist * Transect_ID * Year, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))))

par(mfrow=c(2,2))
plot(lm(Viable_Pods^(1/2) ~ City_dist, (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))))
ggqqplot((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods^(1/2))
shapiro.test((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods^(1/2))
...
diag_urb_pods_2 <- lm(Viable_Pods ~ Urb_score * Year * Transect_ID,
                      data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))
...
# try log transformation
gg_reshist(lm(log(Viable_Pods+1) ~ Urb_score * Transect_ID * Year, fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))), bins=20)
par(mfrow=c(2,2))
plot(lm(log(Viable_Pods+1) ~ Urb_score* Transect_ID * Year,  fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
summary(lm(log(Viable_Pods+1) ~ Urb_score* Transect_ID * Year, fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
ggqqplot(log( fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods+1))
shapiro.test(log( fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods+1))
# still not good (too strong?)


# try sq rt
gg_reshist(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year,
              fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")), bins=20)
plot(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year,
        fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")))
summary(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year,
           fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")))
ggqqplot(fertile_pops_all_notNApods$Viable_Pods^(1/2) %>% filter(Transect_ID != "Rural"))
shapiro.test( fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/2)
...
plot(lm(Viable_Pods^(1/3) ~ Urb_score * Transect_ID * Year,
        fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
ggqqplot(fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/3))
shapiro.test(fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/3))
# still not great but better than log & cube root. going with sq rt
...
lm.pods.subt.1 <- lm(Viable_Pods_sqrt ~ Year * City_dist * Transect_ID,
                     data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South")))
...
```{r}
### No transect yet
pods_glmer_gradient_01 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist * as.factor(Year),
                                fertile,
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
pods_glmer_gradient_02 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist + as.factor(Year),
                                fertile,
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model
pods_glmer_subtr_01 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
                             (fertile %>%
                                filter(Transect_ID != 'Rural')),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
pods_glmer_subtr_02 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist:Transect_ID + City_dist:as.factor(Year) + as.factor(Year):Transect_ID + City_dist + as.factor(Year) + Transect_ID,
                             (fertile %>% filter(
                               Transect_ID != 'Rural')),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
```{r}
### No transect yet
u_pods_glmer_gradient_1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score * as.factor(Year),
                                 fertile,
                                 family = "poisson",
                                 glmerControl(optimizer="bobyqa",
                                              optCtrl = list(maxfun = 100000)))
...
u_pods_glmer_gradient_1.1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year),
                                   fertile,
                                   family = "poisson",
                                   glmerControl(optimizer="bobyqa",
                                                optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
u_pods_glmer_subtr_1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score * as.factor(Year) * Transect_ID,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn
u_pods_glmer_subtr_1.1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:as.factor(Year) + Urb_score:Transect_ID + as.factor(Year):Transect_ID,
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.2 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Transect_ID + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.3 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Urb_score + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.4 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Urb_score + Transect_ID:as.factor(Year),
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.5 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.6 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.7 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Transect_ID:as.factor(Year),
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
# main effects only
u_pods_glmer_subtr_1.8 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID ,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
# try out new glmer
x1 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist * as.factor(Year), 
...
x2 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID, 
            (long_plant_means_peds %>%
               filter(Transect_ID != 'Rural')),
            family = "poisson",
            glmerControl(optimizer="bobyqa",
...
x2.2 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:City_dist + Transect_ID:as.factor(Year),
              (long_plant_means_peds %>%
                 filter(Transect_ID != 'Rural')),
              family = "poisson", 
            glmerControl(optimizer="bobyqa",
...
x2.3 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:City_dist + City_dist:as.factor(Year),
              (long_plant_means_peds %>%
                 filter(Transect_ID != 'Rural')),
              family = "poisson", 
              glmerControl(optimizer="bobyqa",
...
x2.4 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist + Transect_ID:as.factor(Year),
              (long_plant_means_peds %>%
                 filter(Transect_ID != 'Rural')),
              family = "poisson", 
              glmerControl(optimizer="bobyqa",
...
x2.5 <- glmer(as.numeric(Peds_per_plant) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID,
              (long_plant_means_peds %>%
                 filter(Transect_ID != 'Rural')),
              family = "poisson",
            glmerControl(optimizer="bobyqa",
...
diag_urb_peds_1 <- lm(Peduncles ~ Urb_score * Year, data = fertile_pops_all_notNApeds)
...
hist(fertile_pops_all_notNApeds$Peduncles)
...
hist(fertile_pops_all_notNApeds$Peduncles^(1/2), breaks = 12)
hist(log(fertile_pops_all_notNApeds$Peduncles + 1), breaks = 12)
hist(fertile_pops_all_notNApeds$Peduncles^(2), breaks = 12)

qplot((fertile_pops_all_notNApeds$Peduncles)^2, bins = 20)
plot(lm((Peduncles^2) ~ Urb_score * Year, data = fertile_pops_all_notNApeds), bins=20)
gg_reshist(lm((Peduncles^2) ~ Urb_score* Year, data = fertile_pops_all_notNApeds), bins=20)
...
summary(glm.nb(Peduncles ~ Urb_score * Year, data = fertile_pops_all_notNApeds))
...
fertile_pops_all_notNApeds$residuals <- residuals(lm((Peduncles ~ Urb_score * Year),data = fertile_pops_all_notNApeds))

# new df with site coordinates and residuals
sites1 <- dplyr::rename(sites, Patch_ID = Pop_ID)
fertile_pops_all_notNApeds <- as.data.frame(fertile_pops_all_notNApeds)
sites_pedresids <- dplyr::full_join(sites1, fertile_pops_all_notNApeds, by = 'Patch_ID')
...
u_ped_glm_gradient_1 <- lm(Peduncles_sq 	~ Year * Urb_score,
                           data = fertile_pops_all_notNApeds)
...
urbpeds_lm <- lm(Peduncles ~ City_dist * as.factor(Year) * Transect_ID,
                 data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural"))
...
qplot(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles, bins = 15)

summary(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)
sd(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)

ggqqplot(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)
## Most data points fall within the envelope but several don't. (towards one end)

# Shapiro-Wilk normality test
shapiro.test(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)
## From the output, the p-value < 0.05 implying that the distribution of the data are significantly different from normal distribution. We cannot assume the normality.

qplot((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2)
plot(lm((Peduncles^2) ~ City_dist * as.factor(Year) * Transect_ID, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")), bins=20)
gg_reshist(lm((Peduncles^2) ~ City_dist * as.factor(Year) * Transect_ID, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")), bins=20)
ggqqplot((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2)
shapiro.test((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2)
# looks really good!
...
diag_urb_peds_2 <- lm(Peduncles ~ Urb_score * as.factor(Year) * Transect_ID,
                      data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural"))
...
qplot((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2, bins = 15)
plot(lm((Peduncles^2) ~ Urb_score * as.factor(Year) * Transect_ID, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")), bins=20)
gg_reshist(lm((Peduncles^2) ~ Urb_score * as.factor(Year) * Transect_ID, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")), bins=20)
ggqqplot((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2)
shapiro.test((fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural")$Peduncles)^2)
# looks really good!
...
lm.peds.subt.3 <- lm(Peduncles_sq	~ Year + City_dist + Transect_ID, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural"))
...
## do this for only 2018
### no error
peds_glmer_gradient_01 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist,
                                (fertile %>% filter(Year == '2018')),
                                family = "poisson")
...
## do this for only 2019
### no error
peds_glmer_gradient_02 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist,
                                (fertile %>% filter(Year == '2019')),
                                family = "poisson")
...
## add transect
# full model
peds_glmer_subtr_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
                            (fertile %>% filter(Transect_ID != 'Rural')),
                            family = "poisson",
                            glmerControl(optimizer="bobyqa",
                                         optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn
peds_glmer_subtr_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist:as.factor(Year) + as.factor(Year):Transect_ID + City_dist:Transect_ID + City_dist + Transect_ID + as.factor(Year),
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and urbscore:year
peds_glmer_subtr_1.2 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):Transect_ID + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and transect:year
peds_glmer_subtr_1.3 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.4 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist + Transect_ID:as.factor(Year), 
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.5 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.6 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# main effects plus transect:year
peds_glmer_subtr_1.7 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:as.factor(Year),
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# main effects only
peds_glmer_subtr_1.8 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID ,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
```{r}
### No transect yet
u_peds_glmer_gradient_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score * as.factor(Year),
                                 fertile,
                                 family = "poisson",
                                 glmerControl(optimizer="bobyqa",
                                              optCtrl = list(maxfun = 100000)))
...
u_peds_glmer_gradient_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score + as.factor(Year),
                                   fertile,
                                   family = "poisson",
                                   glmerControl(optimizer="bobyqa",
                                                optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
u_peds_glmer_subtr_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score * as.factor(Year) * Transect_ID,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn
u_peds_glmer_subtr_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + as.factor(Year):Transect_ID + Urb_score:as.factor(Year) + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and urbscore:year
u_peds_glmer_subtr_1.2 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + as.factor(Year):Transect_ID + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.3 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + as.factor(Year):Transect_ID + Urb_score:as.factor(Year) + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and transect:year
u_peds_glmer_subtr_1.4 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Urb_score:as.factor(Year) + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.5 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa", 
                                             optCtrl = list(maxfun = 100000)))
...
u_peds_glmer_subtr_1.6 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:as.factor(Year) +  Urb_score + Transect_ID + as.factor(Year), 
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson", 
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.7 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Transect_ID:as.factor(Year) +  Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa", 
                                             optCtrl = list(maxfun = 100000)))
...
# main effects
u_peds_glmer_subtr_1.8 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score + Transect_ID + as.factor(Year),
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
```{r}
height_lmer_gradient_1 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist * as.factor(Year),
                               fertile,
                               REML = F)
...
height_lmer_gradient_1.1 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist + as.factor(Year), 
                                 fertile,
                                 REML = F)
...
# ADD SUBTRANSECTS
# full model
height_lmer_subtr_01 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
                             (fertile %>% filter(Transect_ID != 'Rural')),
                             REML = F)
...
# full model minus 3-way interaxn
height_lmer_subtr_02 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist:Transect_ID + Transect_ID:as.factor(Year) + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID, 
                             (fertile %>% filter(Transect_ID != 'Rural')),
                             REML = F)
...
```{r}
u_height_lmer_gradient_1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score * as.factor(Year),
                                 fertile,
                                 REML = F)
...
u_height_lmer_gradient_2 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year), 
                                 fertile,
                                 REML = F)
...
# ADD SUBTRANSECTS
# full model
u_height_lmer_subtr_1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score * as.factor(Year) * Transect_ID,
                              fertile,
                              REML = F)
...
# full model minus 3-way interaxn
u_height_lmer_subtr_1.1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:as.factor(Year) + Urb_score:Transect_ID + as.factor(Year):Transect_ID, 
                                fertile,
                                REML = F)
...
# full model minus 3-way interaxn and urbscore:year
u_height_lmer_subtr_1.2 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:Transect_ID + as.factor(Year):Transect_ID,
                                fertile,
                                REML = F)
...
# full model minus 3-way interaxn and urbscore:transect
u_height_lmer_subtr_1.3 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:as.factor(Year) + as.factor(Year):Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.4 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:as.factor(Year) + Urb_score:Transect_ID, 
                                fertile,
                                REML = F)
...
# main effects + urbscore:transect
u_height_lmer_subtr_1.5 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + Urb_score:Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.6 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.7 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID + as.factor(Year):Urb_score,
                                fertile,
                                REML = F)
...
# main effects
u_height_lmer_subtr_1.8 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + as.factor(Year) + Transect_ID,
                                fertile,
                                REML = F)
...
### No transect yet
# full model
podperped_lmer_gradient_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist * as.factor(Year),
                                   fertile,
                                   REML = F,
...
podperped_lmer_gradient_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist + as.factor(Year),
                                   fertile,
                                   REML = F,
                                   lmerControl(optimizer="bobyqa",
                                               optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
podperped_lmer_subtr_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                REML = F,
                                lmerControl(optimizer="bobyqa",
...
# full model minus 3-way interaxn
podperped_lmer_subtr_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:as.factor(Year) + Transect_ID:City_dist + City_dist:as.factor(Year),
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                REML = F,
                                lmerControl(optimizer="bobyqa",
...
podperped_lmer_subtr_03 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) +
                                ...
                                (fertile %>% filter(Transect_ID != 'Rural')), REML = F, lmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
```{r}
### No transect yet
u_podsperped_lmer_gradient_1 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score * as.factor(Year),
                                     fertile,
                                     REML = F,
                                     lmerControl(optimizer="bobyqa",
                                                 optCtrl = list(maxfun = 100000)))
...
u_podsperped_lmer_gradient_1.1 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score + as.factor(Year),
                                       fertile,
                                       REML = F,
                                       lmerControl(optimizer="bobyqa",
                                                   optCtrl = list(maxfun = 100000)))
...
## add transect
#full model
u_podsperped_lmer_subtr_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score * as.factor(Year) * Transect_ID,
                                   (fertile %>% filter(Transect_ID != 'Rural')),
                                   REML = F,
                                   lmerControl(optimizer="bobyqa",
                                               optCtrl = list(maxfun = 100000)))
...
u_podsperped_lmer_subtr_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) +
                                     ...
                                     as.factor(Year) + 
                                     Transect_ID,
                                   (fertile %>% filter(Transect_ID != 'Rural')), REML = F,
...
# 2018
inf.1 <- lm(Peduncles_sq	~ City_dist, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural") %>% filter(Year == '2018'))
...
# 2019
inf.2 <- lm(Peduncles_sq	~ City_dist, data = fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural") %>% filter(Year == '2019'))
...
# PODS --------
Q1_reg_pod_u <- ggplot(fertile_pops_all_notNApods, aes(x = Urb_score, y = Viable_Pods_sqrt, shape=Year)) + labs(
  # x = "Urbanization Score",
    y = expression(Follicles^{0.5})) +
  scale_x_reverse() +
  geom_point(aes(shape=Year, color=Year),  size=2) +
...
# PEDUNCLES --------
Q1_reg_ped_u <- ggplot(fertile_pops_all_notNApeds, aes(x = Urb_score, y = Peduncles_sq, shape=Year)) + 
  labs(
    # x = "Urbanization Score",
       y = expression(Inflorescences^{2})) +
  scale_x_reverse() +
...
# PODS-----
Q2_reg_pod_subtr <- ggplot((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South")),
...
# PEDUNCLES----
Q2_reg_ped_subtr <- ggplot(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural"),
                           aes(x = City_dist,
                               y = Peduncles_sq,
                               group=interaction(Year,Transect_ID),
                               color=interaction(Year,Transect_ID),
...
# PODS-----
Q2_reg_pod_subtr_u <- ggplot(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")), aes(Urb_score, Viable_Pods_sqrt,
                                 group=interaction(Year,Transect_ID),
                                 color=interaction(Year,Transect_ID),
                                 linetype=interaction(Year,Transect_ID),
                                 shape=interaction(Year,Transect_ID)
...
# PEDUNCLES----
Q2_reg_ped_subtr_u <- ggplot(fertile_pops_all_notNApeds %>% filter(Transect_ID != "Rural"), aes(Urb_score, Peduncles_sq,
                                 group=interaction(Year,Transect_ID),
                                 color=interaction(Year,Transect_ID),
                                 linetype=interaction(Year,Transect_ID),
                                 shape=interaction(Year,Transect_ID)
