...
diversity <- merge(x=melted,y=tax,by="Morphospecies_Code",all.x=TRUE) %>%
  ...
  left_join(., AvgVars_notNA_Poll_18_19 %>%
...
ggplot(diversity %>%
  ...
  theme_bw()
  ggsave(here::here("Figures_Tables/Q3_Pollinator/Supplement", "4_most_populous_families.png"),
...
ggsave(here::here("Figures_Tables/Q3_Pollinator/Supplement", "Honeybees_per_plant.png"),
