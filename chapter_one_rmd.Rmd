...
test1 <- lapply(best_mods_Q2.urbscore_list, tidy_sb) %>%
  ...
  dplyr::mutate_if(.,
                is.character,
                str_replace_all,
                pattern = c("Year:Urbanization Score"),
                replacement = c("Urbanization Score:Year")) %>%
  arrange(factor(Predictor, levels = c("Urbanization Score",
                                       "Year",
                                       "Subtransect",
                                       "Urbanization Score:Year",
                                       "Subtransect:Urbanization Score",
                                       "Year:Subtransect",
                                       "Year:Subtransect:Urbanization Score"
                                       )))
