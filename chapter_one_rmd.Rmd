...
bound_poll <- bind_cols(formulas_poll,
                        glance_poll %>%
                          dplyr::select(AIC, BestModels)) # Models 1, 3 lowest AIC
...
u_bound_poll <- bind_cols(u_formulas_poll,
                        u_glance_poll %>%
                          dplyr::select(AIC, BestModels)) # Models 1 lowest AIC
...
# glmmTMB::Anova.glmmTMB(glmmTMB::glmmTMB(Viable_Pods ~ (1|Patch_ID) + City_dist:Year +
#                                   City_dist +
#                                   Year, 
#                                 data = fertile,
...
# all main effects and secondary interactions
pods_glmer_gradient_02 <- update(pods_glmer_gradient_01,
                                 . ~ . -City_dist:Year)
...
plot(simulateResiduals(pods_glmer_gradient_02)) # looks good
...
pods_glmer_gradient_02_anova <- car::Anova(pods_glmer_gradient_02) %T>%
  print() # nothing sig
...
# all main effects and secondary interactions
pods_glmer_subtr_02 <- update(pods_glmer_subtr_01,
                              . ~ . -Year:Transect_ID:City_dist)

# all main effects and 2/3 secondary interactions
pods_glmer_subtr_03 <- update(pods_glmer_subtr_02,
                              . ~ . -Transect_ID:City_dist)
pods_glmer_subtr_04 <- update(pods_glmer_subtr_02,
                              . ~ . -Year:City_dist)
pods_glmer_subtr_05 <- update(pods_glmer_subtr_02,
                              . ~ . -Year:Transect_ID)

# all main effects and 1/3 secondary interactions
pods_glmer_subtr_06 <- update(pods_glmer_subtr_03,
                              . ~ . -Year:City_dist)
pods_glmer_subtr_07 <- update(pods_glmer_subtr_04,
                              . ~ . -Year:Transect_ID)
pods_glmer_subtr_08 <- update(pods_glmer_subtr_05,
                              . ~ . -Transect_ID:City_dist)

# all main effects
pods_glmer_subtr_09 <- update(pods_glmer_subtr_08,
                              . ~ . -Year:City_dist)
...
# check residuals
plot(simulateResiduals(pods_glmer_subtr_01)) # looks good


summary(pods_glmer_subtr_01)
pods_glmer_subtr_01_anova <- car::Anova(pods_glmer_subtr_01) %T>%
  print()
...
# all main effects and secondary interactions
u_pods_glmer_gradient_1.1 <- update(u_pods_glmer_gradient_1,
                              . ~ . -Urb_score:Year)
...
plot(simulateResiduals(u_pods_glmer_gradient_1.1)) # looks good


summary(u_pods_glmer_gradient_1)
u_pods_glmer_gradient_1_anova <- car::Anova(u_pods_glmer_gradient_1) %T>%
  print() # urb_score marg sig

summary(u_pods_glmer_gradient_1.1)
u_pods_glmer_gradient_1.1_anova <- car::Anova(u_pods_glmer_gradient_1.1) %T>%
  print() # urb_score marg sig
```
...
# all main effects and secondary interactions
u_pods_glmer_subtr_02 <- update(u_pods_glmer_subtr_01,
                              . ~ . -Year:Transect_ID:Urb_score)

# all main effects and 2/3 secondary interactions
u_pods_glmer_subtr_03 <- update(u_pods_glmer_subtr_02,
                              . ~ . -Transect_ID:Urb_score)
u_pods_glmer_subtr_04 <- update(u_pods_glmer_subtr_02,
                              . ~ . -Year:Urb_score)
u_pods_glmer_subtr_05 <- update(u_pods_glmer_subtr_02,
                              . ~ . -Year:Transect_ID)

# all main effects and 1/3 secondary interactions
u_pods_glmer_subtr_06 <- update(u_pods_glmer_subtr_03,
                              . ~ . -Year:Urb_score)
u_pods_glmer_subtr_07 <- update(u_pods_glmer_subtr_04,
                              . ~ . -Year:Transect_ID)
u_pods_glmer_subtr_08 <- update(u_pods_glmer_subtr_05,
                              . ~ . -Transect_ID:Urb_score)

# all main effects
u_pods_glmer_subtr_09 <- update(u_pods_glmer_subtr_08,
                              . ~ . -Year:Urb_score)
...
u_bound_pods <- bind_cols(u_formulas_pods,
                        u_glance_pods %>%
                          dplyr::select(AIC, BestModels)) # Models 1,2,3,4,6 lowest AIC. Model 4 is the best though.

# check residuals
plot(simulateResiduals(u_pods_glmer_subtr_01)) # looks good
plot(simulateResiduals(u_pods_glmer_subtr_02)) # looks good
plot(simulateResiduals(u_pods_glmer_subtr_03)) # looks good
plot(simulateResiduals(u_pods_glmer_subtr_04)) # looks good
plot(simulateResiduals(u_pods_glmer_subtr_06)) # looks good


summary(u_pods_glmer_subtr_01)
u_pods_glmer_subtr_01_anova <- car::Anova(u_pods_glmer_subtr_01) %T>%
  print()

summary(u_pods_glmer_subtr_02)
u_pods_glmer_subtr_01_anova <- car::Anova(u_pods_glmer_subtr_02) %T>%
  print()

summary(u_pods_glmer_subtr_03)
u_pods_glmer_subtr_01_anova <- car::Anova(u_pods_glmer_subtr_03) %T>%
  print()

summary(u_pods_glmer_subtr_04)
u_pods_glmer_subtr_01_anova <- car::Anova(u_pods_glmer_subtr_04) %T>%
  print()

summary(u_pods_glmer_subtr_06)
u_pods_glmer_subtr_01_anova <- car::Anova(u_pods_glmer_subtr_06) %T>%
  print()
...
# glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist * Year, fertile, family = "poisson", glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
peds_glmer_subtr_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist * Year * Transect_ID,
...
peds_glmer_subtr_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist:Year + Year:Transect_ID + City_dist:Transect_ID + City_dist + Transect_ID + Year,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.2 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Year:Transect_ID + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.3 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Year:City_dist + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.4 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Year:City_dist + Transect_ID:Year, 
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.5 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Year:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.6 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Transect_ID:City_dist,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.7 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Transect_ID:Year,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# main effects only
peds_glmer_subtr_1.8 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + Year + Transect_ID ,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
u_peds_glmer_gradient_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score + Year,
                                   fertile,
                                   family = "poisson",
                                   glmerControl(optimizer="bobyqa",
                                                optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
u_peds_glmer_subtr_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score * Year * Transect_ID,
                              (fertile %>% filter(Transect_ID != 'Rural')),
                              family = "poisson",
                              glmerControl(optimizer="bobyqa",
                                           optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn
u_peds_glmer_subtr_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Year:Transect_ID + Urb_score:Year + Urb_score + Transect_ID + Year,
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and urbscore:year
u_peds_glmer_subtr_1.2 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Year:Transect_ID + Urb_score + Transect_ID + Year,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.3 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Year:Transect_ID + Urb_score:Year + Urb_score + Transect_ID + Year,
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and transect:year
u_peds_glmer_subtr_1.4 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Urb_score:Year + Urb_score + Transect_ID + Year,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.5 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Transect_ID + Urb_score + Transect_ID + Year,
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa", 
                                             optCtrl = list(maxfun = 100000)))
...
u_peds_glmer_subtr_1.6 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score:Year +  Urb_score + Transect_ID + Year, 
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson", 
                                glmerControl(optimizer="bobyqa",
...
u_peds_glmer_subtr_1.7 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Transect_ID:Year +  Urb_score + Transect_ID + Year,
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa", 
                                             optCtrl = list(maxfun = 100000)))
...
# main effects
u_peds_glmer_subtr_1.8 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + Urb_score + Transect_ID + Year,
                                (fertile %>% filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
```{r}
height_lmer_gradient_1 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist * Year,
                               fertile,
                               REML = F)
...
height_lmer_gradient_1.1 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist + Year, 
                                 fertile,
                                 REML = F)
...
# ADD SUBTRANSECTS
# full model
height_lmer_subtr_01 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist * Year * Transect_ID,
                             (fertile %>% filter(Transect_ID != 'Rural')),
                             REML = F)
...
# full model minus 3-way interaxn
height_lmer_subtr_02 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist:Transect_ID + Transect_ID:Year + City_dist:Year + City_dist + Year + Transect_ID, 
                             (fertile %>% filter(Transect_ID != 'Rural')),
                             REML = F)
...
```{r}
u_height_lmer_gradient_1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score * Year,
                                 fertile,
                                 REML = F)
...
u_height_lmer_gradient_2 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year, 
                                 fertile,
                                 REML = F)
...
# ADD SUBTRANSECTS
# full model
u_height_lmer_subtr_1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score * Year * Transect_ID,
                              fertile,
                              REML = F)
...
# full model minus 3-way interaxn
u_height_lmer_subtr_1.1 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Year + Urb_score:Transect_ID + Year:Transect_ID, 
                                fertile,
                                REML = F)
...
# full model minus 3-way interaxn and urbscore:year
u_height_lmer_subtr_1.2 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Transect_ID + Year:Transect_ID,
                                fertile,
                                REML = F)
...
# full model minus 3-way interaxn and urbscore:transect
u_height_lmer_subtr_1.3 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Year + Year:Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.4 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Year + Urb_score:Transect_ID, 
                                fertile,
                                REML = F)
...
# main effects + urbscore:transect
u_height_lmer_subtr_1.5 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.6 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Transect_ID,
                                fertile,
                                REML = F)
...
u_height_lmer_subtr_1.7 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Urb_score,
                                fertile,
                                REML = F)
...
# main effects
u_height_lmer_subtr_1.8 <- lmer(Height_Sept ~ (1|Patch_ID) + Urb_score + Year + Transect_ID,
                                fertile,
                                REML = F)
...
### No transect yet
# full model
podperped_lmer_gradient_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist * Year,
                                   fertile,
                                   REML = F,
...
podperped_lmer_gradient_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist + Year,
                                   fertile,
                                   REML = F,
                                   lmerControl(optimizer="bobyqa",
                                               optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
podperped_lmer_subtr_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist * Year * Transect_ID,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                REML = F,
                                lmerControl(optimizer="bobyqa",
...
# full model minus 3-way interaxn
podperped_lmer_subtr_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist + Year + Transect_ID + Transect_ID:Year + Transect_ID:City_dist + City_dist:Year,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                REML = F,
                                lmerControl(optimizer="bobyqa",
...
# full model minus 3-way interaxn and Transect_ID:Year 
...
# full model minus 3-way interaxn and City_dist:Year
...
```{r}
### No transect yet
u_podsperped_lmer_gradient_1 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score * Year,
                                     fertile,
                                     REML = F,
                                     lmerControl(optimizer="bobyqa",
                                                 optCtrl = list(maxfun = 100000)))
...
u_podsperped_lmer_gradient_1.1 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score + Year,
                                       fertile,
                                       REML = F,
                                       lmerControl(optimizer="bobyqa",
                                                   optCtrl = list(maxfun = 100000)))
...
## add transect
#full model
u_podsperped_lmer_subtr_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + Urb_score * Year * Transect_ID,
                                   (fertile %>% filter(Transect_ID != 'Rural')),
                                   REML = F,
                                   lmerControl(optimizer="bobyqa",
                                               optCtrl = list(maxfun = 100000)))
