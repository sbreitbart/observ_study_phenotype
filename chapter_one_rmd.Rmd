...
####### All data
```{r}
Perc_change_gradient.zi(peds_glmer_gradient_01)

# differences between 2018-2019: 2019 had this much more peduncles/inflors, on avg, than 2018
...
####### Transects
```{r}
Perc_change_gradient.urbansites(peds_glmer_subtr_01)

# differences between transects: 2019 had this much more peduncles/inflors, on avg, than 2018
fixed.effects(peds_glmer_subtr_01)$zi[4]

Perc_change_subtransects(peds_glmer_subtr_01)
```
