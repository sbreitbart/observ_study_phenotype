...
# Try a transformation: 
gg_reshist(lm(simpson^2 ~ Urb_score, data = div_sum ), bins=15 ) # looks good enough
gg_reshist(lm(simpson^(3) ~ Urb_score, data = div_sum ), bins=15 )
gg_reshist(lm(log(1-simpson) ~ Urb_score, data = div_sum ), bins=15) 
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Pollinator_regressions.pdf", width = 12, height = 7)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Pollinator_regressions_transects.pdf", width = 12, height = 7)
```
