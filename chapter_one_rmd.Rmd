...
###### GLMER
####### City_dist, not urb_score
######## All sites (be sure to indicate that model is zero-inflated and minus 1, so results need to be explained with that in mind!!)
```{r}
...
bound_u_peds <- bind_cols(formulas_u_peds,
                        glance_u_peds %>%
                          dplyr::select(AIC, BestModels)) # Models 3,4,6 lowest AIC but best is 3
