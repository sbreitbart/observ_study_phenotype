...
```{r}
### No transect yet
pods_glmer_gradient_01 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist * Year,
                                fertile,
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
pods_glmer_gradient_02 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist + Year,
                                fertile,
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
                                             optCtrl = list(maxfun = 100000)))
...
# full model
pods_glmer_subtr_01 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist * Year * Transect_ID,
                             (fertile %>%
                                filter(Transect_ID != 'Rural')),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
pods_glmer_subtr_02 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + City_dist:Transect_ID + City_dist:Year + Year:Transect_ID + City_dist + Year + Transect_ID,
                             (fertile %>% filter(
                               Transect_ID != 'Rural')),
                             family = "poisson",
                             glmerControl(optimizer="bobyqa",
...
```{r}
### No transect yet
u_pods_glmer_gradient_1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score * Year,
                                 fertile,
                                 family = "poisson",
                                 glmerControl(optimizer="bobyqa",
                                              optCtrl = list(maxfun = 100000)))
...
u_pods_glmer_gradient_1.1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year,
                                   fertile,
                                   family = "poisson",
                                   glmerControl(optimizer="bobyqa",
                                                optCtrl = list(maxfun = 100000)))
...
## add transect
# full model
u_pods_glmer_subtr_1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score * Year * Transect_ID,
...
# full model minus 3-way interaxn
u_pods_glmer_subtr_1.1 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Urb_score:Year + Urb_score:Transect_ID + Year:Transect_ID,
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.2 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Transect_ID + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.3 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Urb_score + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.4 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Urb_score + Transect_ID:Year,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.5 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Year:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.6 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Transect_ID:Urb_score,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
u_pods_glmer_subtr_1.7 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID + Transect_ID:Year,
                                (fertile %>% 
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
...
# main effects only
u_pods_glmer_subtr_1.8 <- glmer(as.numeric(Viable_Pods) ~ (1|Patch_ID) + Urb_score + Year + Transect_ID ,
                                (fertile %>%
                                   filter(Transect_ID != 'Rural')),
                                family = "poisson",
                                glmerControl(optimizer="bobyqa",
