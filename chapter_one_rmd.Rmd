...
######### Transects
```{r}
car::Anova(lm_diversity.urbsubs.u) # transect sig
...
summary(lm_diversity.urbsubs.u_ME) # corridor transect was 0.147 units diversity lower than non-corridor subtransect
```
...
####### Transects
```{r}
car::Anova(lm.even.urbsubs.u) # transect sig
car::Anova(lm.even.urbsubs.u_ME) # transect sig

AIC(lm.even.urbsubs.u,lm.even.urbsubs.u_ME ) # main effects model lower AIC (but <2 away)
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_Evenness.pdf", width = 12, height = 7)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_nohoneybees.pdf", width = 12, height = 7)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_transects_nohoneybees.pdf", width = 12, height = 7)
```
