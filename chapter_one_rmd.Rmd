...
# add sqrt(pods) col to df
(fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods_sqrt <- sqrt((fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South"))$Viable_Pods)
```
...
summary(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods)
sd(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods)

gg_reshist(diag_urb_pods_2, bins = 20)

ggqqplot(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods)
## Almost all data points fall within the envelope but some along one end don't


# try log transformation
gg_reshist(lm(log(Viable_Pods+1) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))), bins=20)
par(mfrow=c(2,2))
plot(lm(log(Viable_Pods+1) ~ Urb_score* Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
summary(lm(log(Viable_Pods+1) ~ Urb_score* Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
ggqqplot(log(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods+1))
shapiro.test(log(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods+1))
# still not good (too strong?)


# try sq rt
gg_reshist(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))), bins=20)
plot(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
summary(lm(Viable_Pods^(1/2) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
ggqqplot(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/2))
shapiro.test(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/2))


# try cube root
gg_reshist(lm(Viable_Pods^(1/3) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))), bins=20)
plot(lm(Viable_Pods^(1/3) ~ Urb_score * Transect_ID * Year, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))))
ggqqplot(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/3))
shapiro.test(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods^(1/3))
# still not great but better than log & cube root. going with sq rt

# add sqrt(pods) col to df
data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods_sqrt <- sqrt(data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural"))$Viable_Pods)
...
```{r}
lm.pods.subt.1 <- lm(Viable_Pods_sqrt ~ Year * City_dist * Transect_ID, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South")))
lm.pods.subt.1_anova <- car::Anova(lm.pods.subt.1, REML = F)
# 3-way interaction not significant, so let's look at lower-level interactions and main effects.

lm.pods.subt.2 <- lm(Viable_Pods_sqrt 	~ Year + City_dist + Transect_ID + Year:City_dist + Year:Transect_ID + City_dist:Transect_ID, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South")))
lm.pods.subt.2_anova <- car::Anova(lm.pods.subt.2, REML = F)
# Nothing significant

lm.pods.subt.3 <- lm(Viable_Pods_sqrt 	~ Year + City_dist + Transect_ID, data = (fertile_pops_all_notNApods %>% filter(Transect_ID == "North" | Transect_ID == "South")))
...
```{r}
u_pod_glm_subtr_1 <- lm(Viable_Pods_sqrt 	~ Year * Urb_score * Transect_ID, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")))
u_pod_glm_subtr_1_anova <- car::Anova(u_pod_glm_subtr_1, REML = F)
# 3-way interaction not significant, so let's look at lower-level interactions and main effects.

u_pod_glm_subtr_2 <- lm(Viable_Pods_sqrt 	~ Year + Urb_score + Transect_ID + Year:Urb_score + Year:Transect_ID + Urb_score:Transect_ID, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")))
u_pod_glm_subtr_2_anova <- car::Anova(u_pod_glm_subtr_2, REML = F)
# Nothing significant

u_pod_glm_subtr_3 <- lm(Viable_Pods_sqrt 	~ Year + Urb_score + Transect_ID, data = data = fertile_pops_all_notNApods %>% filter(Transect_ID != "Rural")))
...
## add transect
# full model
peds_glmer_subtr_1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID, (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn
peds_glmer_subtr_1.1 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist:as.factor(Year) + as.factor(Year):Transect_ID + City_dist:Transect_ID + City_dist + Transect_ID + as.factor(Year), (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson", glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
car::Anova(peds_glmer_subtr_1.1)
AIC(peds_glmer_subtr_1.1)
# AIC <2 from full model

# full model minus 3-way interaxn and urbscore:year
peds_glmer_subtr_1.2 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):Transect_ID + Transect_ID:City_dist, (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# full model minus 3-way interaxn and transect:year
peds_glmer_subtr_1.3 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist + Transect_ID:City_dist, (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.4 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist + Transect_ID:as.factor(Year), (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.5 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + as.factor(Year):City_dist, (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
peds_glmer_subtr_1.6 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:City_dist, (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# main effects plus transect:year
peds_glmer_subtr_1.7 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:as.factor(Year), (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# main effects only
peds_glmer_subtr_1.8 <- glmer(as.numeric(Peduncles) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID , (fertile %>% filter(Transect_ID != 'Rural')), family = "poisson",
            glmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
...
# ADD SUBTRANSECTS
# full model
height_lmer_subtr_01 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID, (fertile %>% filter(Transect_ID != 'Rural')), REML = F)
...
# full model minus 3-way interaxn
height_lmer_subtr_02 <- lmer(Height_Sept ~ (1|Patch_ID) + City_dist:Transect_ID + Transect_ID:as.factor(Year) + City_dist:as.factor(Year) + City_dist + as.factor(Year) + Transect_ID, (fertile %>% filter(Transect_ID != 'Rural')), REML = F)
...
(fertile %>% filter(Transect_ID != 'Rural')) <- fertile %>% filter(Transect_ID != 'Rural')
```
...
## add transect
# full model
podperped_lmer_subtr_01 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist * as.factor(Year) * Transect_ID, (fertile %>% filter(Transect_ID != 'Rural')), REML = F,
...
# full model minus 3-way interaxn
podperped_lmer_subtr_02 <- lmer(as.numeric(pods_per_ped) ~ (1|Patch_ID) + City_dist + as.factor(Year) + Transect_ID + Transect_ID:as.factor(Year) + Transect_ID:City_dist + City_dist:as.factor(Year), (fertile %>% filter(Transect_ID != 'Rural')), REML = F,
            lmerControl(optimizer="bobyqa", optCtrl = list(maxfun = 100000)))
