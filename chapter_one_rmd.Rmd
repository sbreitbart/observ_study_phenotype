...
fixef(poll_glmer_gradient_01.v2)

fixef(glmmTMB(as.numeric(Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist,
        long_Transect_Data_18_19 %>% filter(Year == "2018"),
        family = "poisson") )
# (Intercept)    City_dist  
#  -0.0008819    0.0109157

Perc_change_gradient(glmmTMB(as.numeric(Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist,
        long_Transect_Data_18_19 %>% filter(Year == "2018"),
        family = "poisson") )
...
fixef(glmmTMB(as.numeric(Pollinia_removed) ~ (1|Patch_ID/Plant_Num/Inflor) + City_dist,
        long_Transect_Data_18_19 %>% filter(Year == "2019"),
        family = "poisson") )
# (Intercept)    City_dist  
#    -0.65393      0.01744
