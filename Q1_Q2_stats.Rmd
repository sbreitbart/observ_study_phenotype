...
car::Anova(peds_glmer_gradient_01_SA.exp) # this is qualitatively identical to original model
car::Anova(peds_glmer_gradient_01_SA.mat) # this is qualitatively identical to original model
car::Anova(peds_glmer_gradient_01)

AIC(peds_glmer_gradient_01,
    peds_glmer_gradient_01_SA.exp, # qualitatively identical (<=2 AIC apart per df)
    peds_glmer_gradient_01_SA.mat) # qualitatively identical (<=2 AIC apart per df)
