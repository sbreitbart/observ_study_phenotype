...
abun_transect <- ggplot(sum_abun %>%
  ...
  geom_smooth(aes(linetype = Transect),
              color = "#00BFC4",
              fill = "#00BFC4",
              method = lm,
              se = T,
...
diversity_simpson_transect <- ggplot(sum_diversity %>%
  ...
  scale_linetype_manual(values = c('dashed', 'solid'),
    ...
    # adding stats from ANOVA
  geom_text(size = 4.25, x=18, y=0.5,
            label = "Distance: p = 0.316",
            hjust = 0) +
    geom_text(size = 4.25, x=18, y=0.47,
            label = "Subtransect: p = 0.009",
            hjust = 0) +
    geom_text(size = 4.25, x=18, y=0.44,
            label = "D x S: p = 0.135",
            hjust = 0) 
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Pollinator_regressions_NOPOINTS.pdf", width = 11, height = 3.75)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Pollinator_regressions_transects_NOPOINTS.pdf", width = 12, height = 4.2)
