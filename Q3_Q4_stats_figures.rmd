...
#   labs(caption = "Error bars represent standard error")
  ...
  # adding stats from ANOVA
          geom_text_npc(aes(npcx = 0.05, npcy = 0.05,
...
abun_transect <- ggplot(sum_abun %>%
  ...
  scale_linetype_manual(values = c('dashed', 'solid'),
    ...
    # legend.direction="horizontal"
  # adding stats from ANOVA
          geom_text_npc(aes(npcx = 0.24, npcy = 0.05,
...
abun_transect.u <- ggplot(sum_abun %>%
 ...
 geom_smooth(method = lm,
  ...
  scale_linetype_manual(values = c('dashed', 'solid'),
                        labels = c("Urban: Corridor",
                                "Urban: Non-Corridor")) +
  # adding stats from ANOVA
        geom_text_npc(aes(npcx = 0.9, npcy = 0.9,
...
diversity_simpson_transect <- ggplot(sum_diversity %>%
  ...
  theme(
    ...
    legend.key = element_rect(fill = NA),
    legend.key.size = unit(1.5, "line")) +
# COMMENTING OUT SCALE_LINETYPE_MANUAL BECAUSE FOR SOME REASON IT'S MESSING WITH THE OVERALL LEGEND FOR AGGREGATED FIGURE...
  scale_linetype_manual(values = c('dashed', 'solid'),
                        labels = c("Urban: Non-Corridor",
                                   "Urban: Corridor")) +
    # ,
    # legend.direction="horizontal"
  # adding stats from ANOVA
          geom_text_npc(aes(npcx = 0.95, npcy = 0.99,
...
even_transect <- ggplot(sum_evenness %>%
  ...
  scale_linetype_manual(values = c('dashed', 'solid'),
                        labels = c("Urban: Corridor",
                                "Urban: Non-Corridor")) +
  # adding stats from ANOVA
        geom_text_npc(aes(npcx = 0.9, npcy = 0.99,
                    label = " Distance: p = 0.316\n Subtransect: p = 0.009\n Distance x Subtransect: p = 135"),
                size = 4.5)
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_urbscore_gradientfigs_nopoints.pdf", width = 12, height = 7.5)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Pollinator/Supplement/Pollinator_regressions_urbscore_transects_nopoints.pdf", width = 12, height = 7.5)
```
