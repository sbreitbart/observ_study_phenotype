...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Regressions_Pollinators/Pollinator_regressions_NOPOINTS.pdf", width = 11, height = 3.75)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q4_Regressions_Pollinators/Pollinator_regressions_transects_NOPOINTS.pdf", width = 12, height = 4.2)
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q3_Regressions_Pollinators/Supplement/Pollinator_regressions_urbscore_gradientfigs_nopoints.pdf", width = 12, height = 7.5)
```
...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q4_Regressions_Pollinators/Supplement/Pollinator_regressions_urbscore_transects_nopoints.pdf", width = 12, height = 7.5)
```
