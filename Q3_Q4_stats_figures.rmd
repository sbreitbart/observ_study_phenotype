...
AIC(lm_abun1_SA.1.exp.ML,
    lm_abun1_SA.1.exp, # SA model <2 AIC/df from original model so it's a better model
    lm_abun1)

car::Anova(lm_abun1_SA.1.exp) # these results are qualitatively identical to original model (p = 0.0071 vs 0.0098)
car::Anova(lm_abun1_SA.1.exp.ML) # these results are qualitatively identical to original model (p = 0.0059 vs 0.0098)
car::Anova(lm_abun1)
...
AIC(lm_abun1_SA.noSA,
    lm_abun1_SA.exp,
    lm_abun1_SA.gaus,
    lm_abun1_SA.rat,
    lm_abun1_SA.sph) # AICs are identical

MuMIn::model.sel(lm_abun1_SA.noSA, # noSA model is best AIC
                 lm_abun1_SA.exp,
                 lm_abun1_SA.gaus,
                 lm_abun1_SA.rat,
                 lm_abun1_SA.sph) # other SA mods' AICs identical
