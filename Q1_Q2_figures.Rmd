...
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables/Q1_Regressions_Plants/URBSCOREGradient_regressions_nopoints.pdf",
             width = 12, height = 7)
...
library(patchwork)
library(png)
Q2_legend <- png::readPNG(here::here("./Figures_Tables/Q2_Regressions_Plants/Q2_legend_nopoints.png"),
                     native = TRUE)
...
# export to PDF
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables//Q2_Regressions_Plants/URBSCORESubtransect_regressions_ggpredict_nopoints.pdf",
             width = 12, height = 8.5)
```
