...
library(patchwork)
library(png)
Q2_legend <- readPNG(here::here("./Figures_Tables//Q2_Regressions_Plants/Q2_legend_nopoints_updated.png"),
                    native = TRUE)
...
# export to PDF
dev.copy2pdf(file="~/R_Projects/chapter_one/Figures_Tables//Q2_Regressions_Plants/DISTSubtransect_regressions_nopoints.pdf",
             width = 12, height = 4.5)
```
