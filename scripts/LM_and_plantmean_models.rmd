...
# Pods per peduncle
## LM- No transformation necessary
### Without transect
#### Diagnostics
...
make_Q1Q2_Anova.lm(best_mods_Q2.dist_list.lm) %>%
  ...
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization and proximity to an urban corridor on 4 traits: pollinaria removed, follicles, inflorescences, and mean no. follicles per inflorescence. Urbanization was quantified via urbanization score. Urbanization was quantified via distance to city center and only urban populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%
    add_footer_lines(paste0("AIC, Inflorescences: ",
                          AIC(peds_lm_subtr_06) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Pollinaria Removed: ",
                          AIC(poll_lm_subtr_06) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles: ",
                          AIC(pods_lm_subtr_08) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles per Inflorescence: ",
                          AIC(podsperped_lm_subtr_08) %>% round(., 3))) %>% 
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Q2_Dist_ANOVA_lm.png"))
...
make_Q1Q2_Anova.lm(best_mods_Q1.urbscore_list.lm) %>%
  ...
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization on 4 traits: pollinaria removed, follicles, inflorescences, and mean no. follicles per inflorescence. Urbanization was quantified via urbanization score and all populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%
    add_footer_lines(paste0("AIC, Inflorescences: ",
                          AIC(u_peds_lm_gradient_01) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Pollinaria Removed: ",
                          AIC(u_poll_lm_gradient_02) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles: ",
                          AIC(u_pods_lm_gradient_02) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles per Inflorescence: ",
                          AIC(u_podsperped_lm_gradient_02) %>% round(., 3))) %>% 
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Q1_Urbscore_ANOVA_lm.png"))
...
make_Q1Q2_Anova.lm(best_mods_Q2.urbscore_list_lm) %>%
  ...
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization and proximity to an urban corridor on 4 traits: inflorescences, pollinaria removed, follicles, and mean no. follicles per inflorescence. Urbanization was quantified via urbanization score. Urbanization was quantified via urbanization score and only urban populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%
    add_footer_lines(paste0("AIC, Inflorescences: ",
                          AIC(u_peds_lm_subtr_06) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Pollinaria Removed: ",
                          AIC(u_poll_lm_subtr_06) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles: ",
                          AIC(u_pods_lm_subtr_06) %>% round(., 3))) %>%
  add_footer_lines(paste0("AIC, Follicles per Inflorescence: ",
                          AIC(u_podsperped_lm_subtr_07) %>% round(., 3))) %>% 
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Q2_Urbscore_ANOVA_lm.png"))
...
make_Q1Q2_Anova.height_lm(height_lm_gradient_02) %>%
  ...
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization on plant height. Urbanization was quantified via distance to city center and all populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%
      add_footer_lines(paste0("AIC, Height: ",
                          AIC(height_lm_gradient_02) %>% round(., 3))) %>%
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Best_models_Height/Q1_Dist_ANOVA_HEIGHT_lm.png"))
...
make_Q1Q2_Anova.height_lm(height_lm_subtr_08) %>%
  ...
  width(j = 2:3, width = 1) %>%
  italic(i = 2, j = 2:3, part = "header") %>%
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization and proximity to an urban corridor on plant height. Urbanization was quantified via distance to city center and only urban populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%    add_footer_lines(paste0("AIC, Height: ",
                          AIC(height_lm_subtr_08) %>% round(., 3))) %>%
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Best_models_Height/Q2_Dist_ANOVA_HEIGHT_lm.png"))
...
make_Q1Q2_Anova.height_lm(u_height_lm_gradient_02) %>%
  ...
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization on plant height. Urbanization was quantified via urbanization score and all populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>% 
  add_footer_lines(paste0("AIC, Height: ",
                          AIC(u_height_lm_gradient_02) %>% round(., 3))) %>%
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Best_models_Height/Q1_Urbscore_ANOVA_HEIGHT_lm.png"))
...
make_Q1Q2_Anova.height_lm(u_height_lm_subtr_07) %>%
  ...
  width(j = 2:3, width = 1) %>%
  italic(i = 2, j = 2:3, part = "header") %>%
  add_footer_lines("Table X: Results from general linear models examining the effects of urbanization and proximity to an urban corridor on plant height. Urbanization was quantified via urbanization score and only urban populations were included. Shown are sum of squares (SS), maximum likelihood chi-square (X2), and p-values (p) obtained from a type II ANOVA.") %>%    add_footer_lines(paste0("AIC, Height: ",
                          AIC(u_height_lm_subtr_07) %>% round(., 3))) %>%
  add_footer_lines("*: p-value <= 0.05") %>%
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Best_models_Height/Q2_Urbscore_ANOVA_HEIGHT_lm.png"))
```
...
lapply(alt_best_mods_Q1.dist_list_lm, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q1_Dist_ANOVA_altmodels_lm.png"))
...
lapply(alt_best_mods_Q2.dist_list_lm.peds, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Dist_ANOVA_altmodels_lm_inflorescences.png"))
...
lapply(alt_best_mods_Q2.dist_list_lm.poll, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Dist_ANOVA_altmodels_lm_pollinaria.png"))
...
lapply(alt_best_mods_Q2.dist_list_lm.pods_podsperped, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Dist_ANOVA_altmodels_lm_follicles_and_follperinflor.png"))
...
lapply(alt_best_mods_Q1.urbscore_list_lm, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q1_Urbscore_ANOVA_altmodels_lm.png"))
...
lapply(alt_best_mods_Q2.urbscore_list_lm.peds, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Urbscore_ANOVA_altmodels_lm_inflors.png"))
...
lapply(alt_best_mods_Q2.urbscore_list_lm.poll, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Urbscore_ANOVA_altmodels_lm_pollinaria.png"))
...
lapply(alt_best_mods_Q2.urbscore_list_lm.pods, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Urbscore_ANOVA_altmodels_lm_follicles.png"))
...
lapply(alt_best_mods_Q2.urbscore_list_lm.podsperped, tidy_sb) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Q2_Urbscore_ANOVA_altmodels_lm_folliclesperinflor.png"))
...
make_Q1Q2_Anova.height_lm(height_lm_gradient_01) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Alt_Models_Height/Q1_Dist_ANOVA_altmodels_HEIGHT_lm.png"))
...
lapply(list(height_lm_subtr_03,
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Alt_Models_Height/Q2_Dist_ANOVA_altmodels_HEIGHT_lm.png"))
...
make_Q1Q2_Anova.height_lm(u_height_lm_gradient_01) %>%
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Alt_Models_Height/Q1_Urbscore_ANOVA_altmodels_HEIGHT_lm.png"))
...
lapply(list(u_height_lm_subtr_04,
  ...
  add_footer_lines("**: p-value <= 0.01") %>%
  add_footer_lines("***: p-value <= 0.001") %>%
  save_as_image(., path = here::here("./Figures_Tables/Q1_Q2_ANOVA/Supplement/lm/Alternative_Models/Alt_Models_Height/Q2_Urbscore_ANOVA_altmodels_HEIGHT_lm.png"))
