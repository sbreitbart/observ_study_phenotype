...
### urban subs
urb_scores_peds_all_long <- dplyr::left_join((fertile %>% filter(Transect_ID != 'Rural')), urb_scores, by = "Patch_ID")
...
### urban subs
urb_scores_height_all_long <- dplyr::left_join((fertile %>% filter(Transect_ID != 'Rural')), urb_scores, by = "Patch_ID")
...
### urban subs
urb_scores_podsperped_all_long <- dplyr::left_join((fertile %>% filter(Transect_ID != 'Rural')), urb_scores, by = "Patch_ID")
